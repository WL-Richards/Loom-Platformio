	...
	class OLED : public LogPlat
	{
		...
		public:
			...
			enum class FreezeType {
				FREEZE_DISABLE, 		///< Freeze disabled
				DATA, 			///< Screen freezes
		...
		protected:
			...
			uint16_t				scroll_duration;	///< The duration to complete a full cycle through a bundle of data (milliseconds)(non-blocking)
		...
		/*@{*/ //======================================================================
			...
			uint16_t			get_scroll_duration() const { return scroll_duration; }
		...
		/*@{*/ //======================================================================
			...
			void			set_scroll_duration(const uint16_t duration) { scroll_duration = duration; }
